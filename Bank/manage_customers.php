...
<body>
 ...
 <input name="search" size="30" type="text" placeholder="Szukaj klientów..." />
                    </div>
...
<div class="flex-item-search-button">
 ...
 <option value="name">Nazwę</option>
                            <option value="acno">NumerID</option>
                        </select>
                    </div>
   ...
   if ($result->num_rows > 0) 
{
       ...
       <div class="flex-item">
                   ...
                   <div class="flex-item-2">
                     ...
                     <p id="acno"><?php echo "NumerID : " . $row["account_no"]; ?></p>
                    </div>
                    <div class="flex-item-1">
  ...
  <div id="dropdown<?php echo $i ?>" class="dropdown-content">
                         ...
                         <a href="edit_customer.php?cust_id=<?php echo $row["cust_id"] ?>">Zobacz/edytuj</a>
  
                          <a href="transactions.php?cust_id=<?php echo $row["cust_id"] ?>">Transakcja</a>
      
                      <a href="delete_customer.php?cust_id=<?php echo $row["cust_id"] ?>"
                                
 onclick="return confirm('Jesteś pewny?')">Usuń</a>
                          </div>
                        </div>
                    </div>
                </div>
