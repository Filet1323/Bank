...
<body>
    <div class="sidenav" id="theSideNav">
     ...
     <a href="javascript:void(0)" id="closebtn" onclick="closeNav()">&times;</a>
        <a href="admin_home.php">START</a>
   
     <a id="label">Klienci</a>
        <a href="customer_add.php">Dodaj klienta</a>
        <a href="manage_customers.php">Zarządzaj klientem</a>
   
     <a id="label">Zarządzanie stroną</a>
        <a href="post_news.php">Dodaj newsa</a>
    </div>
