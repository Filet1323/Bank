...
<?php echo "Dodano klienta pomyślnie !\n"; ?></p>
        </div>
...
{ ?>
                <p id="info"><?php echo "Stworzono konto pomyślnie !\n"; ?></p>
            <?php
            } else { ?>
                <p id="info">
<?php
 ...
 <?php
            if (($conn->query($sql4) === TRUE)) { ?>
                <p id="info"><?php echo "Zaktualizowano konto !\n"; ?></p>
  ...
  <?php } ?>
      ...
      <p id="info"><?php echo "Beneficjent utworzono pomyślnie !\n"; ?></p>
            <?php
            } else { ?>
                <p id="info">
<?php
...
?>
        ...
        <div class="flex-item">
            <a href="customer_add.php" class="button">Dodaj ponownie</a>
        </div>
