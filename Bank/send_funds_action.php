 ...
 $row0 = $result0->fetch_assoc();
   ...
   $updated_sender_balance = $sender_balance - $amt;
     ...
     $row2 = $result2->fetch_assoc();
      ...
      'Wysłano do: ".$row5["first_name"]." ".$row5["last_name"].", Numer konta: ".$row5["account_no"]."',
                        '$amt',
   ...
   $sql4 = "INSERT INTO passbook".$receiver_id." VALUES(
                       ...
                       'Otrzymane od: ".$row0["first_name"]." ".$row0["last_name"].", Numer konta: ".$row0["account_no"]."',
...
<body>
 ...
 <div class="flex-container">
        <div class="flex-item">
            ...
            if ($err_no == -1) { ?>
                <p id="info">
<?php echo "Błąd połączenia ! Spróbuj ponownie później.\n"; ?></p>
            <?php } ?>

            <?php
            if ($err_no == 0) { ?>
      
          <p id="info"><?php echo "Przeniesienie powiodło się !\n"; ?></p>
            <?php } ?>

            <?php
            if ($err_no == 1) { ?>
               
 <p id="info"><?php echo "Niewystarczające środki !\n"; ?></p>
            <?php } ?>

            <?php
            if ($err_no == 2) { ?>
                
<p id="info"><?php echo "Wprowadzono nieprawidłowe hasło !\n"; ?></p>
            <?php } ?>
        </div>
