...
<body>
  ...
  <form class="add_customer_form" action="atm_simulator_action.php" method="post">
    ...
    <div class="flex-container-form_header">
            <h1 id="form_header">Bankomat symulator</h1>
        </div>

 
       <div class="flex-container">
            <div class=container>
                <label>Wpisz ilość pieniędzy:</label>
<br>
   ...
   <div class="container">
    ...
    <label id="radio-label" for="debit-radio"><span class="radio">Debet</span></label>
                </div>
             
   <div class="container">
                    <input type="radio" name="type" value="credit" id="credit-radio">
      
              <label id="radio-label" for="credit-radio"><span class="radio">Kredyt</span></label>
                </div>
