...
<body>
 ...
 <div class="nav-wrapper">
  ...
  <a href="javascript:void(0);" class="icon" onclick="openNav()" id="hamburger">
            ...
            <a id="user">Witaj   <?php echo $row["first_name"]; ?> !</a>
     
       <a id="logout" href="logout_action.php" onclick="return confirm('Jesteś pewny?')">Wyloguj</a>
          
  <a id="profile" href="customer_profile.php">Mój profil</a>
        </div>
    </div>
