...
<body>
    <form class="add_customer_form" action="pass_change_action.php" method="post">
        <div class="flex-container-form_header">
            <h1 id="form_header">Zmień hasło/PIN</h1>
        </div>
        ...
        <div class="flex-container">
            ...
            <div class="flex-container-radio">
                <div class="container">
                    ...
                    <label id="radio-label" for="password-radio"><span class="radio" >Hasło</span></label>
                </div>
                <div class="container">
        ...
        <div class="flex-container">
            <div  class=container>
                <label>Wpisz stare hasło :</b></label><br>
        ...
        <div class="flex-container">
            ...
            <div  class=container>
                <label>Wpisz nowe hasło ponownie :</b></label><br>
