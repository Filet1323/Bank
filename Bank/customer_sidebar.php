...
<body>
    ...
    <a href="javascript:void(0)" id="closebtn" style="padding: 10px 20px;"
      ...
      <a href="customer_home.php">START</a>
        <a href="customer_transactions.php">Moje transakcje</a>
        <a id="label">Wyślij/Odbierz</a>
      
  <a href="beneficiary.php">Przekaż fundusze</a>
        <a href="atm_simulator.php">Bankomat symulator</a>
