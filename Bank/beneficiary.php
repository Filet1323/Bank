...
<body>
    ...
    <div class="search-bar" id="the-search-bar">
       ...
       <a class="add-button" href="add_beneficiary.php">Dodaj</a>

                <form class="search_form" action="" method="post">
  
                  <div class="flex-item-search">
                        <input name="search" size="30" type="text" placeholder="Szukaj..." />
    ...
    <div class="flex-container">
        <p id="info">Wyślij, Dodaj lub usuń Beneficjentów.</p>
